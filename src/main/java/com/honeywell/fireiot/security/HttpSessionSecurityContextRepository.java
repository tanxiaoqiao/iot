...
//    public static final String SPRING_SECURITY_CONTEXT_KEY = "SPRING_SECURITY_CONTEXT";
    public static final String SPRING_SECURITY_CONTEXT_KEY = "CURRENT_USER";
...
//        SecurityContext context = readSecurityContextFromSession(httpSession);
        ...
        Object userOb = httpSession == null ? null : httpSession.getAttribute(springSecurityContextKey);
        ...
        if (userOb == null) {
            ...
            // 模拟生成Authentication
            User userDto = JSONObject.parseObject(userOb.toString(), User.class);
            AuthorityUser authorityUser = new AuthorityUser();
            BeanUtils.copyProperties(userDto, authorityUser);
            // 更新用户状态
    ...
    public void saveContext(SecurityContext context, HttpServletRequest request,
        ...
        SaveToSessionResponseWrapper responseWrapper = WebUtils
        ...
        protected void saveContext(SecurityContext context) {
            ...
            if (httpSession != null) {
                ...
                if (contextChanged(context)
                    ...
                    // Session中存入处理后的User
                    AuthorityUser currentUser = (AuthorityUser) context.getAuthentication().getPrincipal();
                    User userDto = currentUser.toUser();
                    userDto.setPassword(null);
                    httpSession.setAttribute(springSecurityContextKey, JSON.toJSONString(userDto));
